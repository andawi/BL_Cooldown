...
local function styleBar(bar)
	...
	if Elv and false then
		...
		bar.candyBarLabel:SetFont("Interface\\AddOns\\oUF_andawi\\media\\fonts\\Pixel8.ttf", 8)
		...
		bar.candyBarDuration:SetFont("Interface\\AddOns\\oUF_andawi\\media\\fonts\\Pixel8.ttf", 8)
